...
class MarkdownConvertStepForm extends StatelessWidget {
  final String nodeId;
  final MarkdownConvertStep node;
  final void Function(String nodeId, VisualStep node) onUpdated;

  const MarkdownConvertStepForm({
    super.key,
    ...
    return Column(
      ...
      children: [
        DropdownButtonFormField<String>(
          ...
          items: const [
            DropdownMenuItem(value: 'markdownToHtml', child: Text('Markdown para HTML')),
            DropdownMenuItem(value: 'htmlToMarkdown', child: Text('HTML para Markdown')),
          ],
          onChanged: (val) {
            if (val != null) {
              node.operation = val;
