...
class _ScriptManagerDialogState extends State<ScriptManagerDialog> {
  ...
  void _createNewScript() {
    ...
    final updatedScripts = List<VisualScript>.from(widget.workspace.scripts)..add(newScript);
  ...
  void _duplicateScript(VisualScript script) {
    ...
    final updatedScripts = List<VisualScript>.from(widget.workspace.scripts)..add(duplicated);
    final updatedWorkspace = widget.workspace..scripts = updatedScripts;
              ...
              child: _selectedScript == null
                  ...
                  : Column(
                      ...
                      children: [
                          ...
                          child: Row(
                            children: [
                              ...
                              DropdownButton<ScriptMode>(
                                ...
                                dropdownColor: isDark ? AppColors.surfaceDark : Colors.white,
                                items: const [
                                  DropdownMenuItem(value: ScriptMode.lowCode, child: Text('Basic (Low-Code)', style: TextStyle(fontSize: 12))),
                                  DropdownMenuItem(value: ScriptMode.advanced, child: Text('Advanced (Code)', style: TextStyle(fontSize: 12))),
                                ],
                                onChanged: (val) {
                                  if (val != null) {
                                    _updateSelectedScript(_selectedScript!.copyWith(mode: val));
                                  }
                                },
                              ),
                            ],
                        ...
                        Expanded(
                          child: _selectedScript!.mode == ScriptMode.advanced
